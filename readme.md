...
## About The Project : 
Compilerd is an online code judge service built using Node.js and Express. It allows users to submit code snippets in various programming languages for compilation and execution.
The service returns the output, execution details, and other properties in the response.
## Quick Usage :
